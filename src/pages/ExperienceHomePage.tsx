...
const EXPERIENCE_CONFIGS: Record<string, ExperienceConfig> = {
  ...
  africa: {
    ...
    name: 'Africa Prime',
    tagline: 'Sport, séries, musique, news — Africa, premium.',
    ...
    timeGreetings: {
      morning: 'Africa — live this morning',
      afternoon: 'Africa — midday',
      evening: 'African prime time',
      late_night: 'Africa — after hours',
    },
    crossExperiences: [
      { id: 'sports', name: 'Sports', gradient: 'from-cyan-500/30 to-blue-500/20', icon: <Trophy className="w-4 h-4" /> },
      { id: 'entertainment', name: 'Entertainment', gradient: 'from-blue-500/30 to-purple-500/20', icon: <Sparkles className="w-4 h-4" /> },
